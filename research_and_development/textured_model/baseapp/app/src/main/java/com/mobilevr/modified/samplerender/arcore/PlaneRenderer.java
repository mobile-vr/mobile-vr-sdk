...
import com.mobilevr.modified.samplerender.Shader.BlendFactor;
...
public class PlaneRenderer {
  ...
  public PlaneRenderer(SampleRender render) throws IOException {
    ...
    mesh = new Mesh(render, Mesh.PrimitiveMode.TRIANGLE_STRIP, indexBufferObject, vertexBuffers, "simple");
  }
  ...
  public void drawPlanes(
    ...
    for (SortablePlane sortedPlane : sortedPlanes) {
      ...
      render.draw(mesh, shader, 0, 0, (float) 0.08, 1, (float) 0.42); // changer ces valeurs
      render.draw(mesh, shader, 1, 0, (float) 0.08, 1, (float) 0.42); // changer ces valeurs
    }
  }
