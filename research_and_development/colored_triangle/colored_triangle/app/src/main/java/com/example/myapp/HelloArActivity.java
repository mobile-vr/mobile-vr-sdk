 ...
 * Modifications:
 *
 * Get the detailed modifications in "Licenses/log_git_diff/log_Mesh.diff"
 * at root of this app.
 */
...
public class HelloArActivity extends AppCompatActivity implements SampleRender.Renderer {
  ...
  private VirtualObject coloredTriangleObject;
   ...
   */
    ...
    public void onSurfaceCreated (SampleRender render){
      ...
      float coloredTriangleCoords[] = {   // in counterclockwise order:
              // the first 3 floats is a position
              // the next 3 floats is a RGB color
              0.0f, 0.5f, -2.0f, 1.0f, 0.0f, 0.0f, // top
              -0.5f, -0.2f, -2.0f, 0.0f, 1.0f, 0.0f, // bottom left
              0.5f, -0.2f, -2.0f, 0.0f, 0.0f, 1.0f  // bottom right
      };

       int coloredTriangleIndex[] = {   // in counterclockwise order:
               0,  1, 2
       };
      vertexShaderFileName = "shaders/coloredShader.vert";
      fragmentShaderFileName = "shaders/coloredShader.frag";
      mode = "useColor";
      coloredTriangleObject = new VirtualObject(
              render,
              COORDS_PER_VERTEX,
     ...
     */
      ...
      coloredTriangleObject.shader.setMat4("uMVPMatrix", uMVPMatrix);

      // drawing the colored triangle on the virtual scene
      render.draw(
              coloredTriangleObject.mesh,
              coloredTriangleObject.shader,
