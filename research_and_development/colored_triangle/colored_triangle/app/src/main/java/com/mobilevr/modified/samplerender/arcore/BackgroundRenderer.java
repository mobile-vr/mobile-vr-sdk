 ...
 */
package com.mobilevr.modified.samplerender.arcore;
...
public class BackgroundRenderer {
  ...
  public BackgroundRenderer(SampleRender render) {
    ...
    mesh =
        new Mesh(render, Mesh.PrimitiveMode.TRIANGLE_STRIP, /*indexBuffer=*/ null, vertexBuffers, "simple");
  }
   ...
   */
  // THIS DRAWS THE IMAGE ON THE BACKGROUND
  public void drawBackground(SampleRender render, float x0, float y0,
                             float u, float v) {
    render.draw(mesh, backgroundShader, 0, x0, y0, u, v);
    render.draw(mesh, backgroundShader, 1, x0, y0, u, v);
  }
  ...
  public void drawVirtualScene(
          SampleRender render, Framebuffer virtualSceneFramebuffer, float zNear, float zFar, float x0, float y0,
          float u, float v) {
    ...
    //render.draw(mesh, occlusionShader, 0);
    //render.draw(mesh, occlusionShader, 1);
    render.draw(mesh, occlusionShader, 2, x0, y0, u, v);
  }
